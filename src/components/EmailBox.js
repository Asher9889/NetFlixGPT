    ...
    return (
        <div className="pt-4 text-center ">
            ...
            <span className=" flex flex-col lg:flex-row gap-4 lg:gap-2 items-center pt-4">
                ...
                <button className="lg:h-14 h-12 lg:w-4/12 bg-[var(--red-color)] hover:bg-[var(--red2-color)] rounded-md text-xl lg:text-2xl px-2 font-netFlixBd tracking-[0.5px] flex flex-row items-center justify-center gap-2">Get Started <HiOutlineChevronRight /></button>
            </span>
        </div>
    )
}
